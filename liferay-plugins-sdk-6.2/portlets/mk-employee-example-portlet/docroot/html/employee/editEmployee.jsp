...
<portlet:renderURL var="addEmployeeActionURL">
	<portlet:param name="action" value="addemployee"></portlet:param>
</portlet:renderURL>

<div align="right">
	<input type="button" value="View Employee"
		onClick="javascript:self.location='<portlet:renderURL><portlet:param name="VIEW_PAGE" value="viewEmployeeList" /></portlet:renderURL>'" />
</div>
